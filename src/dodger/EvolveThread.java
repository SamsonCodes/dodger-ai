...
public class EvolveThread extends Thread
{
    ...
    {
        wp = new WavPlayer();
        crossGen(dodger.getHiddenLayers(), dodger.getPopulation(), dodger.getGenerations(), "_23-10-18-v5_");
        calculated = true;
    }
    ...
    private void crossGen(int[] hiddenNeurons, int popSize, int generations, String subTag)
    {
        ...
        evoState.setMessage("Generation" + generation + ": 0/" + generations + ", Current Best = " 
                + currentGenScore[0] + ", Historical Best = " + topScore);
...
//            }
            System.arraycopy(newGen, 0, currentGen, 0, newGen.length);
            ...
            evoState.setMessage("Generation" + generation + ": " + g + "/" + generations + 
                    ", Current Best = " + currentGenScore[0] + ", Historical Best = " + topScore);
    ...
    private void saveProgress(String tag)
    {
        ...
        if (currentGen != null)
        {
            ...
            for (Network network : currentGen)
            {
                data.add(network.createSaveData());
            }
